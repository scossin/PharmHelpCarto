...
library(rvest)
library(dplyr)
text_rvest <- read_html("./Pharm'Help25032020.html") ## downloaded manually
...
writeLines(text = json_infos_coord, con="infos_coord25032020.json")
voir <- jsonlite::fromJSON("infos_coord25032020.json") ## check it opens correctly
