...
library(rvest)
library(dplyr)
text_rvest <- read_html("./Pharm'Help.html") ## downloaded manually
...
writeLines(text = json_infos_coord, con="infos_coord07042020.json")
voir <- jsonlite::fromJSON("infos_coord07042020.json") ## check it opens correctly
